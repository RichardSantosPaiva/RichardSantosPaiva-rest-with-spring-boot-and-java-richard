...
public class PersonController {	
	...
	@Operation(summary = "Adds a new Person",
		description = "Adds a new Person by passing in a JSON, XML or YML representantion of the person",
		tags = {"People"},
		responses = {
			@ApiResponse(description =  "Success", responseCode = "200", 
				content = 
	...
	@Operation(summary = "Updates a Person",
		description = "Updates a  Person by passing in a JSON, XML or YML representantion of the person",
		tags = {"People"},
		responses = {
	...
	@Operation(summary = "Deletes a Person",
		description = "Deleted a  Person by passing in a JSON, XML or YML representantion of the person",
		tags = {"People"},
		responses = {
			@ApiResponse(description =  "No content", responseCode = "204", content = @Content),
			@ApiResponse(description =  "Bad Request", responseCode = "400", content = @Content),
