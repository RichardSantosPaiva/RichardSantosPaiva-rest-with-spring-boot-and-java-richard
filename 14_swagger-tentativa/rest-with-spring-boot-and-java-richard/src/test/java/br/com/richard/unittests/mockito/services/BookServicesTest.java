package br.com.richard.unittests.mockito.services;
...
import br.com.richard.unittests.mapper.mocks.MockBook;
...
class BookServicesTest {
	...
	void testFindAll() {
		...
		assertEquals("launch date Test1", bookFour.getLaunchDate());
		assertEquals("Price Test1", bookFour.getPrice());
		...
		assertEquals("Author Test1",bookSeven.getAuthor());
		assertEquals("launch date Test1", bookSeven.getLaunchDate());
		assertEquals("Price Test1", bookSeven.getPrice());
		assertEquals("Title Test1", bookSeven.getTitle());
	}
